  ...
  <div class="container-fluid">
    ...
    <div id="navbar" class="navbar-collapse collapse">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="${pageContext.request.contextPath}/admin/cate/getAdminCates">咖啡分类管理</a></li>
        <li><a href="${pageContext.request.contextPath}/admin/information/getAdminInformations">资讯信息管理</a></li>
        <li><a href="${pageContext.request.contextPath}/admin/coffee/getAdminCoffee">咖啡信息管理</a></li>
        <li><a href="${pageContext.request.contextPath}/admin/message/getAdminMessages">留言信息管理</a></li>
